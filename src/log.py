...
class InterceptHandler(logging.Handler):
    ...
    Обработчик для перехвата стандартных логов Python и перенаправления их в Loguru.
     ...
     Обеспечивает:
    - Соответствие уровней логирования между стандартной библиотекой и Loguru
    - Корректное отображение места вызова в стеке вызовов
    - Поддержку исключений и трассировки стека
    ...
    def emit(self, record):
        ...
        1. Определяет соответствующий уровень логирования в Loguru
        2. Находит место вызова в стеке вызовов
        3. Перенаправляет сообщение в Loguru с сохранением контекста
        """
